...
let handler = async (m, { conn, usedPrefix, command }) => {
    ...
    let images = `https://api.lolhuman.xyz/api/random/quotesimage?apikey=${apichan}`
    let res = await fetch(`https://api.lolhuman.xyz/api/random/quotesnime?apikey=${apichan}`)
